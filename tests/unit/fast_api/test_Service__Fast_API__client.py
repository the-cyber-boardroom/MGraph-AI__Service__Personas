...
from mgraph_ai_service_personas.fast_api.routes.Routes__Info          import ROUTES_PATHS__INFO, ROUTES_INFO__HEALTH__RETURN_VALUE
from mgraph_ai_service_personas.fast_api.routes.Routes__Respond       import ROUTES_PATHS__RESPOND
from mgraph_ai_service_personas.fast_api.routes.Routes__Translate     import ROUTES_PATHS__TRANSLATE
...
class test_Service__Fast_API__client(TestCase):
    ...
    def test__config_fast_api_routes(self):
        assert self.fast_api.routes_paths() == sorted(  ROUTES_PATHS__INFO          +
                                                        ...
                                                        ROUTES_PATHS__RESPOND       +
                                                        ROUTES_PATHS__TRANSLATE     )